...
(function () {
  ...
  // Each tier is { H, M, V, B, R } defaulting to 0.
  // ---------------------------------------------------------------------------
  function impacts(t1, t2, t3, t4, t5) {
    var base = { H: 0, M: 0, V: 0, B: 0, R: 0 };
    function merge(obj) {
  ...
  var TASKS = [
    ...
    // ---- Non-Routine Manual (29-33) ----
    {
      ...
      impacts: impacts(
        { H: 0, M: 0, V: 1, B: 0, R: 0 },   // T1 — robotic assist exists but no role elimination
        { H: 0, M: 1, V: 1, B: 1, R: 1 },   // T2 — AI copilots guide procedures, slight cost pressure
        { H: 0, M: 1, V: 1, B: 1, R: 1 },   // T3 — autonomous surgical bots in narrow domains, trust barrier holds
        { H: 1, M: 2, V: 2, B: 2, R: 2 },   // T4 — AGI surgeons handle routine ops, humans on complex cases
        { H: 2, M: 2, V: 2, B: 2, R: 3 }    // T5 — most procedures AI-led, surgery can't go 10x faster (V capped)
      )
    },
    {
      id: 30,
      ...
      category: 'non_routine_manual',
      impacts: impacts(
        { H: 0, M: 0, V: 0, B: 0, R: 0 },   // T1 — AI barely touches physical trades
        { H: 0, M: 1, V: 1, B: 0, R: 0 },   // T2 — AR/AI guides reduce rework, mild cost savings
        { H: 0, M: 1, V: 1, B: 1, R: 1 },   // T3 — robotic assistants handle some subtasks
        { H: 1, M: 2, V: 2, B: 1, R: 1 },   // T4 — general-purpose robots start displacing routine trade work
        { H: 2, M: 2, V: 2, B: 2, R: 2 }    // T5 — advanced robotics handles most, bespoke craft still human
      )
    },
    {
      id: 31,
      ...
      category: 'non_routine_manual',
      impacts: impacts(
        { H: 0, M: 0, V: 1, B: 0, R: 0 },   // T1 — AI dispatching and resource coordination
        { H: 0, M: 1, V: 2, B: 0, R: 1 },   // T2 — predictive models speed situational awareness
        { H: 0, M: 1, V: 2, B: 1, R: 1 },   // T3 — autonomous drones handle recon/delivery
        { H: 1, M: 2, V: 2, B: 1, R: 2 },   // T4 — AI systems manage logistics, humans on-ground
        { H: 2, M: 2, V: 3, B: 2, R: 2 }    // T5 — AI-led crisis response, humans for judgment calls
      )
    },
    {
      id: 32,
      ...
      category: 'non_routine_manual',
      impacts: impacts(
        { H: 0, M: 0, V: 1, B: 0, R: 0 },   // T1 — GPS/drone mapping assists
        { H: 0, M: 1, V: 1, B: 0, R: 0 },   // T2 — AI-guided navigation and data collection
        { H: 0, M: 1, V: 1, B: 1, R: 1 },   // T3 — autonomous rovers/drones handle some surveys
        { H: 1, M: 2, V: 2, B: 1, R: 2 },   // T4 — general-purpose field robots, humans supervise
        { H: 2, M: 2, V: 2, B: 2, R: 2 }    // T5 — most field work robotic, novel environments still human
      )
    },
    {
      id: 33,
      ...
      category: 'non_routine_manual',
      impacts: impacts(
        { H: 0, M: 0, V: 0, B: 0, R: 0 },   // T1 — AI doesn't replace human touch
        { H: 0, M: 1, V: 1, B: 0, R: 0 },   // T2 — scheduling/monitoring tools free up caregiver time
        { H: 0, M: 1, V: 1, B: 0, R: 1 },   // T3 — companion bots handle logistics, not connection
        { H: 0, M: 1, V: 1, B: 1, R: 1 },   // T4 — AGI companions exist but trust/empathy barrier holds
        { H: 1, M: 2, V: 1, B: 2, R: 1 }    // T5 — some displacement, but human connection stays core (H low)
      )
    },
    ...
    // ---- Cross-Cutting / Meta (34-35) ----
    {
      ...
      impacts: impacts(
        { H: 0, M: 1, V: 1, B: 2, R: 0 },   // T1 — AI assists checks, verification IS the moat
        { H: 0, M: 1, V: 2, B: 2, R: 1 },   // T2 — continuous audit tools, orgs start reshaping around verification
        { H: 0, M: 2, V: 2, B: 3, R: 3 },   // T3 — verification becomes THE bottleneck role, massive reorg
        { H: 1, M: 2, V: 2, B: 3, R: 3 },   // T4 — some routine audits automated, but judgment stays human
        { H: 1, M: 2, V: 3, B: 3, R: 3 }    // T5 — AI audits AI, but final sign-off stays human (H capped at 1)
      )
    },
    {
      id: 35,
      ...
      category: 'cross_cutting',
      impacts: impacts(
        { H: 0, M: 1, V: 2, B: 1, R: 0 },   // T1 — AI already monitors 24/7, high V out the gate
        { H: 0, M: 2, V: 3, B: 1, R: 1 },   // T2 — AI handles detection/response at machine speed
        { H: 1, M: 2, V: 3, B: 2, R: 2 },   // T3 — autonomous defense agents, some analyst roles shift
        { H: 2, M: 3, V: 3, B: 2, R: 2 },   // T4 — AI vs AI arms race, humans do strategy
        { H: 2, M: 3, V: 3, B: 3, R: 3 }    // T5 — fully autonomous cyber defense, humans set policy
      )
    }
  ];
  ...
  var SECTORS = [
    {
      ...
      narratives: {
        dominant: {
          H: 'Your underwriters, claims adjusters, and compliance analysts are being replaced by models that process applications, flag fraud, and file regulatory reports without coffee breaks or error rates. The humans become exception handlers for the machines.',
          M: 'AI is consolidating what used to take a team of junior analysts, a compliance officer, and an underwriter into a single automated pipeline. Your org chart is about to compress by two layers.',
          V: 'Every portfolio manager, loan officer, and relationship banker now has an AI co-pilot that drafts risk memos, pre-fills KYC checks, and models deal structures in seconds. The ones who adopt it double their book. The ones who don\'t become expensive bottlenecks.',
          B: 'Your credit risk models, actuarial tables, and fraud detection systems are being rebuilt from scratch by AI that spots patterns no human quant ever could. The old models aren\'t just outdated — they\'re liabilities.',
          R: 'AI is enabling fintech startups to offer underwriting, lending, and insurance products that bypass your entire institutional infrastructure. Your moat was regulatory complexity. AI just drained it.'
        },
        scenarios: {
          price_floor_drops: 'Actuarial expertise, credit risk modeling, and regulatory interpretation — the knowledge that took decades to accumulate and commanded $400/hour — is being encoded into systems that any competitor can deploy. Your senior analysts\' institutional memory is no longer a competitive advantage; it\'s a training dataset.',
          solo_operator: 'Deal structuring that required a banker, a lawyer, a compliance officer, and an underwriter in a room can now be orchestrated by a single person with AI tools. The coordination cost that justified your headcount just evaporated.',
          verification_bottleneck: 'AI lets a solo financial advisor offer institutional-grade risk modeling, compliance filing, and portfolio optimization. The bundled service model — where clients paid for the firm\'s infrastructure — collapses when a two-person shop can match your output.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Redeploy your operations and compliance staff now — not after the quarterly review. Build an internal AI operations center where former analysts become AI supervisors, exception handlers, and model validators. The transition window is 18 months, not 5 years.',
          M: 'Redesign your org around AI-augmented pods: one senior professional + AI tools replacing teams of 4-6. Start with credit analysis and compliance, where the ROI is immediate and measurable. Your middle management layer needs a new reason to exist — find it or lose it.',
          V: 'Mandate AI tool adoption across your advisory and analysis teams within 90 days. Track AI-assisted vs. unassisted productivity per banker. The gap will be so stark it makes the business case for you. Bankers who resist aren\'t being traditional — they\'re being uncompetitive.',
          B: 'Commission an AI rebuild of your core risk models, pricing engines, and fraud detection systems. Run them in parallel with legacy systems for one quarter, then cut over. Every month you wait, your models drift further from reality.',
          R: 'Launch a skunkworks fintech unit that operates with AI-native infrastructure and zero legacy constraints. Let it cannibalize your own products. Better you than the startup that\'s already building it.',
          price_floor_drops: 'Your actuaries and senior risk analysts need to become AI model trainers and validators, not manual calculators. Capture their expertise in AI systems now, while they\'re still on payroll. Once they retire, that knowledge walks out the door — or into a competitor\'s training data.',
          solo_operator: 'Restructure deal teams around AI-orchestrated workflows where one senior professional manages what five people used to coordinate. Retrain coordinators as AI workflow designers. The alternative is paying five salaries for one person\'s output.',
          verification_bottleneck: 'Build modular service offerings that can compete at every price point — from AI-automated basic services to human-led premium advisory. If you only sell the bundle, unbundlers will cherry-pick your most profitable lines.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI reads radiology scans faster than your radiologists, transcribes clinical notes in real time, auto-codes medical records for billing, and triages patient intake before a nurse touches a chart. The diagnostic and administrative backbone of your hospital is being replaced by systems that never take a shift off.',
          M: 'Medical coders, transcriptionists, scheduling coordinators, and insurance pre-authorization staff — the administrative layer that consumed 30% of healthcare spending — are being absorbed into AI pipelines. Your back office is shrinking while your patient volume stays the same.',
          V: 'Physicians with AI-assisted diagnostics read imaging studies in a third of the time. Clinical researchers synthesize trial data in hours instead of months. Lab technicians get AI-flagged anomalies before they even look at the slide. Output per clinician is climbing — and staffing models built for the old pace are breaking.',
          B: 'AI is democratizing specialist-level diagnostic capability to general practitioners, rural clinics, and nurse practitioners. A community health center with AI reads a chest X-ray as accurately as a fellowship-trained radiologist. The expertise moat around tertiary care centers is crumbling.',
          R: 'AI-powered clinical decision support is catching drug interactions, flagging sepsis risk, and recommending treatment protocols faster and more consistently than human judgment alone. The physician who ignores AI recommendations is practicing medicine with one eye closed.'
        },
        scenarios: {
          price_floor_drops: 'Specialist physicians, rare-disease researchers, and senior pharmacologists — the clinicians you waited 18 months to recruit — their diagnostic pattern recognition is now embedded in AI tools accessible to every provider. The knowledge scarcity that justified $600K salaries is dissolving.',
          solo_operator: 'Care coordination across hospitalists, specialists, pharmacists, social workers, and discharge planners collapses into AI-orchestrated care pathways. The case manager who spent hours on the phone coordinating handoffs watches AI do it in seconds.',
          verification_bottleneck: 'Patients no longer need the full hospital system for every encounter. AI-powered remote monitoring, at-home diagnostics, and virtual triage unbundle primary care, chronic disease management, and routine diagnostics from the physical facility. Your census drops while the care still gets delivered.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered ambient documentation, automated medical coding, and intelligent scheduling across every department within 90 days. Physicians should never touch a chart again. The 40% of their day spent on paperwork becomes 40% more patient-facing time — or 40% fewer physicians needed.',
          M: 'Eliminate the administrative middle layer. Medical coders, transcriptionists, prior-auth staff, and scheduling coordinators need to be retrained as AI workflow managers or redeployed to patient-facing roles. Every dollar spent on manual administration is a dollar wasted.',
          V: 'Mandate AI-assisted diagnostics for every imaging study, lab panel, and clinical encounter. Track diagnostic accuracy and time-to-diagnosis before and after. The productivity gains will reshape your staffing ratios, your patient throughput, and your financial model simultaneously.',
          B: 'Extend AI diagnostic tools to every access point — community clinics, telehealth platforms, nursing facilities, home health. The specialist shortage doesn\'t get solved by training more specialists. It gets solved by distributing their expertise through AI to every provider.',
          R: 'Integrate AI clinical decision support into every order set, every prescription, and every discharge plan. Make it the default — physicians opt out of AI recommendations, not into them. The liability landscape is shifting: not using available AI will become the negligence claim.',
          price_floor_drops: 'Capture your specialists\' diagnostic patterns, treatment protocols, and clinical judgment in AI training data now. Their expertise is more valuable as a scalable AI asset than as a single clinician\'s intuition. Build proprietary clinical AI that reflects your institution\'s standards of care.',
          solo_operator: 'Redesign care pathways around AI-orchestrated coordination. Automated handoffs, AI-generated discharge plans, and real-time bed management replace the case managers and coordinators who spent their days on the phone. The humans focus on complex cases and patient relationships.',
          verification_bottleneck: 'Build your own AI-powered remote care platform before your patients find someone else\'s. Offer AI-triaged virtual visits, remote monitoring with AI-analyzed biometrics, and at-home diagnostic kits with AI interpretation. If you only deliver care inside your walls, you\'ll watch your patient volume migrate to platforms that don\'t have walls.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI writes production code, resolves support tickets, patches vulnerabilities, and deploys to prod — all without a standup. Your junior and mid-level engineers aren\'t being augmented. They\'re being outperformed by their own tools.',
          M: 'The roles that stitched your engineering org together — project managers, QA testers, DevOps engineers, tier-1 support — are being absorbed into AI-powered pipelines. Your 50-person team delivers what used to require 200.',
          V: 'Senior engineers with AI tools are shipping features at 5-10x the velocity of entire teams without them. Sprint planning becomes a formality when one person can do the sprint.',
          B: 'AI isn\'t just writing code — it\'s designing architectures, identifying security vulnerabilities, and refactoring technical debt faster than your best staff engineers. The craft of software engineering is being redefined in real time.',
          R: 'A solo developer with AI ships a production SaaS product in a weekend. Your 18-month roadmap with 40 engineers just became a competitive joke. The barrier to building software collapsed and took your moat with it.'
        },
        scenarios: {
          price_floor_drops: '10x engineers, principal architects, and security specialists — the people you couldn\'t hire and couldn\'t afford to lose — their pattern recognition is now embedded in AI tools available to everyone. Your talent moat just became a public utility.',
          solo_operator: 'Cross-functional teams with PMs, designers, frontend, backend, QA, and DevOps collapse into single engineers orchestrating AI agents. The coordination overhead that justified your org structure vanishes.',
          verification_bottleneck: 'AI enables solo developers and micro-teams to build, ship, and operate software that previously required full engineering orgs. Your enterprise clients don\'t need your 200-person team when a 5-person startup delivers the same product in half the time.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Restructure your engineering org around AI-augmented development now. Redefine roles: junior engineers become AI code reviewers, mid-levels become AI orchestrators, seniors become system architects. The old career ladder doesn\'t exist anymore — build the new one before your best people leave for companies that already have.',
          M: 'Collapse your cross-functional teams into AI-augmented pods. One senior engineer + AI replaces the PM/dev/QA/DevOps squad. Retrain your PMs as product strategists and your QA engineers as AI output validators. The people who coordinated work need new work to do.',
          V: 'Set a 90-day mandate: every engineer uses AI coding tools for every task. Measure output per engineer before and after. The productivity gains will be so dramatic they\'ll reshape your headcount planning, your hiring strategy, and your competitive positioning simultaneously.',
          B: 'Rebuild your development pipeline around AI-native practices: AI-generated code, AI-reviewed PRs, AI-monitored production, AI-driven incident response. Run legacy and AI pipelines in parallel for 30 days, then cut over. Technical debt that would take your team years to fix gets resolved in weeks.',
          R: 'Launch AI-native product lines that compete with your own offerings at 10x lower cost. If a two-person startup can build your product in a month, you need to be that startup — inside your own company — before someone else is.',
          price_floor_drops: 'Capture your senior engineers\' architectural knowledge and security expertise in AI-accessible systems before the talent market reprices their skills downward. Their value shifts from doing the work to teaching AI to do the work.',
          solo_operator: 'Redesign your team topology for AI-native coordination: async AI handoffs replace standups, AI-generated status reports replace PM check-ins, automated testing replaces QA sprints. The humans focus on judgment calls, not information routing.',
          verification_bottleneck: 'Build and sell modular AI-powered development tools alongside your monolithic products. If customers can unbundle your offering, be the one selling the pieces. Your platform advantage only lasts if you weaponize it before someone routes around it.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI generates campaign copy, produces social media assets, edits video, and builds storyboards faster than your creative team can brief each other on the project. The junior copywriter, the production assistant, the stock-footage researcher — their workflows are being swallowed whole by generative tools that never miss a deadline.',
          M: 'The production pipeline that required copywriters, designers, editors, motion graphics artists, and post-production houses collapses into a creative director and an AI stack. Your 30-person content team delivers what used to take 100 — and the freelance bench you relied on is pricing against free.',
          V: 'A single content strategist with AI tools produces more campaign variations, more platform-specific assets, and more A/B test iterations in a day than your entire creative department produced in a week. The bottleneck shifts from production to judgment.',
          B: 'AI puts professional-grade design, video editing, and copywriting capability in the hands of every marketing coordinator and social media manager. The creative craft that took a decade to master is now accessible to anyone with taste and a prompt. Your mid-tier creatives are squeezed from both sides.',
          R: 'AI-native content platforms let brands produce and distribute campaigns without agencies, without production companies, without media buyers. Your clients are realizing they don\'t need your 15% commission when AI gives them the same output for a subscription fee.'
        },
        scenarios: {
          price_floor_drops: 'Elite creative directors, award-winning copywriters, and senior producers — the talent that defined your agency\'s voice — their aesthetic instincts and storytelling frameworks are being absorbed into AI systems that any brand manager can wield. The taste gap is narrowing.',
          solo_operator: 'A campaign launch that required a creative director, art director, copywriter, designer, video editor, media planner, and account manager coordinating across six weeks now gets orchestrated by two people and AI in six days. The agency model was built on coordination overhead. That overhead just evaporated.',
          verification_bottleneck: 'Brands no longer need the full-service agency. AI lets them unbundle: automated social content here, AI-generated ad creative there, algorithmic media buying everywhere. Your retainer model depended on bundled complexity. The bundle is shattering.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Restructure your creative team now. Junior copywriters and production assistants become AI-output curators. Designers become art directors who steer AI generation. The old production roles don\'t exist anymore — rebuild the org around AI-augmented creative direction before your clients figure out they can do it themselves.',
          M: 'Collapse your production pipeline. One creative director with AI tools replaces the copywriter-designer-editor-producer chain. Retrain your producers as AI workflow architects and your account managers as strategic consultants. The people who coordinated production need to add value somewhere AI can\'t.',
          V: 'Mandate AI-assisted content creation across every client engagement within 30 days. Measure output volume, turnaround time, and client satisfaction before and after. The productivity explosion will force a pricing conversation: move to value-based fees before clients demand it.',
          B: 'Rebuild your creative process around AI-native workflows: AI-generated concept variations reviewed by creative directors, AI-produced assets refined by art directors, AI-drafted copy polished by senior writers. The human role shifts from making to choosing.',
          R: 'Launch AI-native content services that compete at price points your traditional agency model can\'t touch. If a brand can produce 80% of their content with AI tools, sell them the 20% that requires human judgment — and the AI infrastructure to handle the rest.',
          price_floor_drops: 'Codify your best creative directors\' instincts — brand voice guidelines, aesthetic frameworks, storytelling patterns — into AI-accessible systems. Their taste becomes exponentially more valuable as AI training data than as individual intuition locked in one person\'s head.',
          solo_operator: 'Redesign your agency operations for AI-native coordination: AI-generated creative briefs, AI-produced first drafts, AI-assembled media plans. The humans focus on strategic judgment and client relationships — not routing information between departments.',
          verification_bottleneck: 'Build modular creative offerings at every price point: fully AI-automated for social content, AI-augmented for campaigns, human-led for brand strategy. If clients can unbundle your retainer, be the one selling the pieces. Your brand expertise only matters if you deploy it before someone routes around it.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI reviews contracts, drafts legal briefs, completes audit workpapers, and generates consulting deliverables at a pace that makes your junior associates look like they\'re working in slow motion. The billable hour model collapses when the work takes minutes instead of weeks.',
          M: 'The pyramid staffing model — partners on top, armies of associates and paralegals below — gets crushed when AI does the base work. You\'re paying for 50 associates to produce what AI delivers before lunch.',
          V: 'Partners and senior consultants with AI tools produce client-ready work at 5x the pace. Due diligence that took a team of eight now takes one lawyer and an afternoon. The question isn\'t whether to adopt — it\'s whether your best people leave for firms that already have.',
          B: 'AI is rewriting how professional judgment gets applied — synthesizing case law, identifying audit risks, modeling tax scenarios, and pressure-testing consulting hypotheses faster and more thoroughly than any human team. The expertise isn\'t obsolete, but the old way of deploying it is.',
          R: 'AI-powered legal tech, automated audit platforms, and algorithmic consulting tools let clients do in-house what they used to hire you for. Your $800/hour partner rate now competes with a $200/month subscription.'
        },
        scenarios: {
          price_floor_drops: 'Decades of legal precedent knowledge, audit methodology expertise, and consulting frameworks — the institutional wisdom that justified partner-track compensation — is being encoded into AI systems that any first-year associate can access. The knowledge asymmetry that built your firm\'s pricing power is dissolving.',
          solo_operator: 'A due diligence process that required partners, associates, paralegals, and support staff coordinating across weeks now gets orchestrated by one senior professional with AI tools in days. The coordination overhead that justified your staffing pyramid just disappeared.',
          verification_bottleneck: 'Clients no longer need to buy the full-service engagement. AI lets them unbundle: automated contract review here, AI-assisted tax filing there, algorithmic audit for routine entities. Your premium pricing depended on bundled complexity. The bundle is breaking apart.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Redesign your staffing model now. Junior associates and paralegals need to become AI-output reviewers and client-facing advisors, not manual document processors. Every month you delay, your cost structure becomes more indefensible against AI-native competitors.',
          M: 'Flatten your pyramid. Build AI-augmented practice groups where one partner and one senior associate, backed by AI, deliver what a team of eight used to. Redeploy displaced professionals into client advisory, AI oversight, and business development — roles the machines can\'t fill.',
          V: 'Mandate AI adoption across all practice areas within 60 days. Track AI-assisted billable output vs. traditional methods. The productivity gap will force a billing model conversation: move to value-based pricing before clients demand it.',
          B: 'Rebuild your practice methodologies around AI-native workflows: AI-drafted briefs reviewed by partners, AI-generated audit workpapers verified by seniors, AI-modeled consulting scenarios validated by experts. The human role shifts from production to judgment.',
          R: 'Launch a separate AI-native service line that competes at lower price points. Offer AI-automated contract review, compliance monitoring, and audit services directly. Cannibalize your own commodity work before legal tech startups do it for you.',
          price_floor_drops: 'Capture your partners\' expertise in AI systems immediately. Build proprietary AI tools trained on your firm\'s institutional knowledge — your case histories, audit findings, consulting frameworks. That knowledge becomes exponentially more valuable as AI training data than as partner intuition.',
          solo_operator: 'Redesign engagement models for AI-orchestrated delivery. One senior professional managing AI workflows replaces the multi-tier team. Retrain your coordination layer — project managers, senior associates who managed junior teams — as AI workflow architects.',
          verification_bottleneck: 'Build modular service offerings at every price point: fully automated for routine work, AI-augmented for complex matters, partner-led for bet-the-company situations. If you only sell the premium bundle, unbundlers will take your bread-and-butter work first.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI generates lesson plans, grades essays, creates assessments, builds personalized learning paths, and answers student questions 24/7 with infinite patience. The adjunct professor grading 150 papers over a weekend is competing with a system that does it in minutes — and provides better feedback.',
          M: 'The administrative scaffolding of education — registrars, admissions processors, academic advisors, financial aid officers — is being absorbed into AI-powered student service platforms. Your 200-person administrative staff does what used to require 500.',
          V: 'Professors with AI tools create entire courses — lectures, readings, assessments, discussion prompts — in days instead of months. Instructional designers build adaptive learning modules at 10x the pace. The bottleneck in education was always content production. That bottleneck just disappeared.',
          B: 'AI puts world-class instruction within reach of every student regardless of institution. A community college student gets AI-powered tutoring as sophisticated as what a Harvard student gets from office hours. The prestige gap in educational quality is collapsing.',
          R: 'AI-native learning platforms deliver personalized education at scale — adaptive pacing, real-time comprehension assessment, custom remediation — that no human instructor can match for a class of 300. The lecture hall model isn\'t just outdated. It\'s pedagogically indefensible against what AI makes possible.'
        },
        scenarios: {
          price_floor_drops: 'Tenured professors, distinguished researchers, and master teachers — the faculty you spent years recruiting — their pedagogical expertise and subject-matter depth are being encoded into AI tutoring systems that any institution can license. The faculty hiring arms race loses its point.',
          solo_operator: 'A course launch that required a professor, instructional designer, LMS administrator, TA coordinator, and department chair coordinating over months now gets assembled by one educator with AI tools in weeks. The administrative overhead that justified your staffing model just evaporated.',
          verification_bottleneck: 'Students no longer need the full university experience for every learning goal. AI-powered micro-credentials, adaptive skill platforms, and personalized tutoring unbundle the degree into components. Your four-year residential model competes with targeted, AI-delivered alternatives that cost a fraction.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered grading, lesson planning, and student advising across every department within one academic year. Faculty should never spend another weekend grading papers by hand. The hours recovered go to research, mentoring, and the irreplaceable human elements of teaching.',
          M: 'Consolidate administrative functions into AI-powered student service platforms. Admissions, financial aid, registration, and academic advising can be 80% automated. Retrain displaced staff as student success coaches and AI system managers — roles that add value machines can\'t.',
          V: 'Mandate AI-assisted course development and assessment creation for all faculty. Track time-to-course-launch and student outcomes before and after. The productivity gains will reshape your faculty workload models, your adjunct dependency, and your cost per student.',
          B: 'Build AI-powered tutoring and adaptive learning into every course offering. Give every student access to personalized instruction that adapts in real time. The institution that makes AI tutoring universal becomes the one that actually delivers on the promise of personalized education.',
          R: 'Launch AI-native learning programs — adaptive micro-credentials, personalized skill pathways, AI-tutored professional development — that compete at price points your traditional degree can\'t touch. If students can get the skills without the degree, sell the skills before someone else does.',
          price_floor_drops: 'Capture your best professors\' pedagogical methods, subject expertise, and advising approaches in AI-accessible systems. Their teaching becomes exponentially more valuable as AI training data than as one section of one course. A single master teacher\'s methods can reach millions.',
          solo_operator: 'Redesign academic operations for AI-native workflows: AI-generated syllabi, AI-assembled reading lists, AI-managed LMS administration, AI-coordinated TA scheduling. Faculty focus on teaching and research — not logistics that a machine handles better.',
          verification_bottleneck: 'Build modular learning offerings at every price point: fully AI-delivered for skill acquisition, AI-augmented for degree programs, faculty-led for research and graduate education. If students can unbundle the degree, be the one selling the modules. Your brand carries farther in pieces than it does locked behind a four-year commitment.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI processes permit applications, reviews benefit claims, classifies FOIA requests, and drafts regulatory correspondence faster than your case workers can open the file. The backlog that defined government service delivery is being cleared by systems that never take a sick day.',
          M: 'The clerical backbone of government — data entry clerks, records processors, permit reviewers, and scheduling coordinators — is being absorbed into AI-powered case management systems. Your agency accomplishes with 200 staff what used to require 600.',
          V: 'Policy analysts with AI tools synthesize legislative research, model regulatory impacts, and draft policy memos in hours instead of weeks. Procurement officers process vendor evaluations at 5x the pace. The bureaucratic speed that citizens complained about is being replaced by AI-driven velocity.',
          B: 'AI puts senior policy expertise within reach of every case worker, every field inspector, and every constituent services representative. A junior analyst with AI tools produces policy briefs as thorough as a 20-year veteran. The expertise gap across GS levels is flattening.',
          R: 'AI-powered decision support helps administrators allocate budgets, prioritize enforcement actions, and route constituent services based on data-driven analysis rather than institutional inertia. The government decisions that affected millions based on gut instinct now run through models that surface what the data actually says.'
        },
        scenarios: {
          price_floor_drops: 'Senior policy analysts, experienced inspectors, and veteran procurement officers — the institutional knowledge holders you couldn\'t replace when they retired — their expertise is being captured in AI systems that any new hire can access on day one. The knowledge drain of government retirement waves just found a fix.',
          solo_operator: 'Inter-agency coordination that required weeks of memos, meetings, and liaison officers collapses into AI-orchestrated workflows that route information, flag dependencies, and track compliance across agencies automatically. The bureaucratic friction that defined government is being automated away.',
          verification_bottleneck: 'Citizens no longer need to navigate the full government apparatus for every service. AI-powered self-service portals, automated eligibility determination, and intelligent case routing unbundle the agency experience. Your office visit becomes a last resort, not a first step.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered case management across every citizen-facing agency within 12 months. Permit processing, benefit determination, and records management should be 80% automated. Retrain displaced clerks as AI system monitors and exception handlers — the humans handle the edge cases, not the routine.',
          M: 'Consolidate administrative functions across agencies into shared AI-powered service platforms. Five agencies don\'t need five separate data entry teams when one AI system processes all their intake. Break the agency-by-agency staffing model that multiplied headcount for decades.',
          V: 'Mandate AI-assisted policy analysis, procurement evaluation, and regulatory review across all departments. Track case processing times and policy output before and after. The efficiency gains will reshape your FTE models, your budget requests, and your service delivery commitments.',
          B: 'Build AI-powered knowledge management systems that capture retiring employees\' institutional expertise before they walk out the door. Every inspection protocol, every policy interpretation, every procurement best practice needs to be AI-accessible to the next generation of civil servants.',
          R: 'Implement AI-powered decision analytics for budget allocation, enforcement prioritization, and program evaluation. Make data-driven the default — not a special initiative, but the way government operates. The decisions that affect millions of citizens deserve the rigor that AI makes possible.',
          price_floor_drops: 'Capture your senior policy analysts\' and veteran inspectors\' expertise in AI training systems before the retirement wave takes it out the door. Their institutional knowledge is a public asset — encode it, scale it, and make it available to every new hire and every citizen-facing system.',
          solo_operator: 'Redesign inter-agency workflows around AI-orchestrated coordination: automated data sharing, AI-routed case referrals, and real-time compliance tracking across agencies. The liaison officers and coordination staff become AI workflow architects who design the automated handoffs.',
          verification_bottleneck: 'Build AI-powered citizen self-service portals that handle 80% of routine interactions — permit applications, benefit checks, records requests, scheduling. Design for the citizen who never wants to visit your office. The ones who do visit get faster service because the queue is shorter.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI-driven vision systems inspect welds, measure tolerances, and flag defects on the production line faster and more consistently than your best quality inspectors. Predictive maintenance algorithms schedule CNC machine servicing before breakdowns happen. Your plant floor is being re-staffed by software.',
          M: 'The layers between your process engineers and the factory floor — shift supervisors tracking OEE metrics, quality techs pulling samples, planners updating the MES — are being compressed into AI dashboards that one plant manager monitors. Three roles become one screen.',
          V: 'Your industrial designers iterate CAD/CAM models with AI-generated design alternatives in hours instead of weeks. Process engineers simulate production line changes before a single bolt moves. The plant that adopts this ships 3x more product variants with the same headcount.',
          B: 'Lean manufacturing expertise that took process engineers a decade to internalize — Kanban flow optimization, six-sigma defect analysis, bill-of-materials rationalization — is now embedded in AI systems that any production supervisor can query. The black belt is a chatbot.',
          R: 'AI enables contract manufacturers to offer just-in-time delivery, custom fabrication, and real-time quality reporting that used to require massive vertically integrated operations. A 50-person shop with AI competes with your 500-person plant on precision and speed.'
        },
        scenarios: {
          price_floor_drops: 'Your veteran process engineers who can diagnose a CNC tolerance drift by ear, your supply chain managers who know which vendors will miss delivery windows before the vendors do — that pattern recognition is being captured in AI models trained on years of production data. The institutional knowledge that made your plant hum is becoming transferable software.',
          solo_operator: 'Coordinating a production run used to require a planner, a procurement lead, a quality manager, and a shift supervisor all in sync. AI now orchestrates the bill of materials, schedules the floor, triggers supplier orders, and monitors quality in one integrated loop. One person oversees what five managed.',
          verification_bottleneck: 'AI lets small specialty manufacturers offer the quality control, supply chain optimization, and predictive maintenance that only large operations could afford. Your scale advantage erodes when a 20-person shop runs AI-optimized production with better defect rates than your legacy line.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered visual inspection and predictive maintenance on your highest-volume production lines within 90 days. Retrain quality inspectors as vision system operators and maintenance techs as AI-monitored reliability engineers. The ROI shows up in defect rates and unplanned downtime — both will drop fast enough to fund the next phase.',
          M: 'Redesign your plant management structure around AI-augmented roles: one production manager overseeing AI-optimized scheduling, quality, and supply chain instead of separate teams for each. The middle layer of your operations org exists to coordinate — AI coordinates better.',
          V: 'Equip every process engineer and industrial designer with AI-powered CAD/CAM and simulation tools. Measure design iteration speed, first-pass yield, and changeover time before and after. The engineers who embrace it will deliver 3-5x more design variants and optimizations.',
          B: 'Capture your veteran engineers\' process knowledge into AI-accessible systems now, while they\'re still on the floor. Run AI-assisted production alongside legacy processes for one quarter, then transition. Every month you wait, institutional knowledge retires without being digitized.',
          R: 'Launch an AI-native manufacturing service line — rapid prototyping, smart quality, predictive supply chain — that competes with the contract manufacturers eating your lunch. If a 50-person shop can match your precision with AI, you need to be that shop at 10x scale.',
          price_floor_drops: 'Your senior process engineers and master machinists hold knowledge that no manual has captured. Build AI apprenticeship programs that pair them with ML engineers to encode their expertise into production AI systems. This is a 12-month window before retirements make it impossible.',
          solo_operator: 'Implement AI-orchestrated production workflows that integrate scheduling, procurement, quality, and floor management into a single system. Retrain your coordinators as AI workflow managers. The five-person coordination chain becomes one person monitoring an AI loop.',
          verification_bottleneck: 'Develop modular AI-powered manufacturing services — quality-as-a-service, predictive-maintenance-as-a-service — that you can sell to smaller manufacturers while using internally. If your operational capabilities are being unbundled, be the one selling the pieces.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI monitors SCADA systems, predicts transformer failures, and files FERC and NERC regulatory reports while your grid engineers are still reviewing yesterday\'s outage logs. Predictive maintenance schedules turbine servicing weeks before a fault cascades. Your power plant operators are becoming supervisors of AI that runs the plant.',
          M: 'The chain from pipeline inspector to field report to engineering review to maintenance dispatch is being collapsed into AI that reads sensor data, generates the inspection report, prioritizes the repair, and dispatches the crew — all before your pipeline integrity manager finishes their morning briefing.',
          V: 'Renewable energy engineers model solar farm layouts, wind turbine placements, and grid integration scenarios with AI that evaluates thousands of configurations overnight. Your substation operators monitor twice the assets with AI-augmented control rooms. Output per engineer doubles without adding a single headcount.',
          B: 'Grid management expertise — load balancing across substations, energy trading optimization, outage response sequencing — knowledge that took utility veterans twenty years to master is now embedded in AI systems that any control room operator can leverage. Smart meters and AI make the grid self-diagnosing.',
          R: 'AI-enabled distributed energy companies are offering microgrid management, predictive maintenance, and regulatory compliance as services that bypass your centralized utility model. The barriers to entry were capital and expertise. AI just eliminated the expertise part.'
        },
        scenarios: {
          price_floor_drops: 'Your senior grid engineers who can balance load across a dozen substations by intuition, your drilling supervisors who read formation pressure like a language — that operational wisdom is being captured by AI trained on decades of SCADA data and field reports. The expertise that justified six-figure salaries is becoming a deployable algorithm.',
          solo_operator: 'An outage response that required a dispatcher, a field crew lead, a grid engineer, and a regulatory liaison coordinating in real time now gets orchestrated by AI that diagnoses the fault, routes the crew, reroutes power, and drafts the incident report simultaneously. Four coordination handoffs become one automated workflow.',
          verification_bottleneck: 'AI enables small energy service companies to offer grid monitoring, predictive maintenance, and compliance filing that used to require a full utility back office. Your integrated service model loses its cost advantage when a 10-person firm with AI delivers the same reliability metrics.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered predictive maintenance on your most critical assets — turbines, transformers, pipeline segments — within 90 days. Retrain field technicians as AI-informed diagnosticians who arrive at every job with the root cause already identified. The reduction in unplanned outages will justify the investment within two quarters.',
          M: 'Consolidate your field operations, grid monitoring, and regulatory compliance into AI-integrated command centers. One operator managing AI dashboards replaces the separate dispatch, monitoring, and reporting teams. The coordination overhead that justified your headcount is being automated.',
          V: 'Equip every grid engineer and renewable energy designer with AI-powered modeling and simulation tools. Mandate adoption for all new project designs within 60 days. The engineers who use AI will evaluate 10x more design alternatives and catch problems that manual analysis misses entirely.',
          B: 'Capture your senior operators\' grid management and field diagnostic expertise in AI training programs now. Partner your most experienced engineers with ML teams to encode institutional knowledge before retirement waves hit. This expertise is perishable — digitize it or lose it.',
          R: 'Build AI-native energy service offerings — microgrid management, predictive maintenance as a service, automated compliance — that compete with the distributed energy companies entering your market. If you only defend the centralized model, the unbundlers will take your most profitable service lines.',
          ...
          solo_operator: 'Redesign outage response and maintenance workflows around AI orchestration: automated fault diagnosis, AI-dispatched crews, real-time regulatory documentation. Retrain dispatchers and coordinators as AI workflow managers. The multi-handoff coordination model is already obsolete.',
          verification_bottleneck: 'Develop modular AI-powered utility services that can be sold independently — grid monitoring, compliance filing, predictive maintenance — alongside your integrated offerings. If distributed energy companies are unbundling your value chain, be the supplier of the pieces.',
    ...
    },
    {
      ...
      narratives: {
        ...
        recommendations: {
          H: 'Deploy AI-powered BIM clash detection, automated cost estimation, and permit filing on your next three projects. Retrain your estimators as AI model validators and your project coordinators as AI workflow managers. The accuracy improvements in cost estimation alone — fewer change orders, tighter bids — will fund the transformation.',
          M: 'Restructure your project delivery teams around AI-augmented pods: one senior PM with AI tools managing what previously required separate estimating, scheduling, and compliance teams. Your overhead ratio is your vulnerability — compress it before competitors do.',
          V: 'Mandate AI-assisted design and scheduling tools for every architect, engineer, and PM in your organization within 90 days. Track bid-to-win ratios, schedule variance, and cost accuracy before and after. The firms that move fastest will dominate project pipelines.',
          B: 'Capture your senior estimators\' and superintendents\' project knowledge into AI-accessible systems immediately. Pair your most experienced people with AI training teams to encode decades of construction judgment — pricing patterns, risk factors, subcontractor reliability — before that expertise retires.',
          R: 'Launch an AI-native construction services division that offers design-to-build delivery with AI-optimized scheduling, estimation, and project management. If a lean tech-enabled contractor can match your delivery quality at lower overhead, you need to be that contractor before someone else is.',
          price_floor_drops: 'Your master tradespeople and senior estimators hold irreplaceable project knowledge. Build structured apprenticeship-to-AI programs that capture their expertise in deployable models. The skilled trades shortage makes this urgent — AI-captured knowledge scales where human mentorship doesn\'t.',
          solo_operator: 'Implement AI-orchestrated project management that integrates BIM, scheduling, procurement, and inspection into a single real-time system. Retrain your coordination staff as AI workflow managers. The weekly coordination meeting becomes a continuous AI feed that one PM monitors.',
          verification_bottleneck: 'Develop modular AI-powered construction services — estimation-as-a-service, scheduling optimization, compliance management — that you can sell to smaller contractors while using internally. If your project management capabilities are being unbundled by tech-enabled startups, sell the pieces yourself.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'AI optimizes delivery routes in real time, matches freight to carriers algorithmically, and manages warehouse picking sequences while your dispatchers are still working yesterday\'s load board. Autonomous vehicle pilots are running fixed-route corridors. Your fleet managers are becoming software operators.',
          M: 'The layers between a shipper\'s order and a driver\'s cab — dispatchers, freight brokers, route planners, customs agents — are being compressed into AI platforms that match loads, optimize routes, clear customs paperwork, and track containers in a single workflow. Five middlemen become one algorithm.',
          V: 'Fleet managers with AI telematics monitor twice the vehicles, warehouse managers with AI-directed picking move 3x the volume, and logistics coordinators with AI-powered freight matching fill more trucks per day. The output-per-person jump makes traditional operations look like they\'re running at half speed.',
          B: 'Route optimization expertise that took veteran dispatchers years to develop — reading weather patterns, knowing which weigh stations to avoid, predicting port congestion — is being encoded in AI systems that any logistics coordinator can deploy. The dispatcher\'s intuition is now a real-time algorithm.',
          R: 'AI-native logistics platforms are offering end-to-end freight matching, route optimization, and customs clearance that bypass traditional freight brokers and 3PLs entirely. A two-person digital broker with AI handles the volume of a 50-person brokerage. Your relationship advantage evaporates when the algorithm is faster and cheaper.'
        },
        scenarios: {
          ...
          solo_operator: 'Moving a container from factory to retail shelf used to require a freight forwarder, a customs broker, a port operator, a trucking dispatcher, and a warehouse manager all in sync. AI now orchestrates the entire chain — booking, routing, clearing, tracking, and scheduling — in one automated workflow that one logistics manager oversees.',
          verification_bottleneck: 'AI enables small carriers and micro-logistics firms to offer the route optimization, freight matching, and compliance filing that only large 3PLs could provide. Your network advantage erodes when a five-truck operation with AI-powered dispatch competes on delivery speed and cost efficiency.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered route optimization and freight matching across your fleet within 90 days. Retrain dispatchers as AI logistics managers who handle exceptions and strategic decisions while the algorithm handles routine routing. The fuel savings and load utilization improvements will be measurable within the first quarter.',
          M: 'Consolidate your dispatch, routing, compliance, and customer service functions into an AI-integrated logistics command center. One operator managing AI dashboards replaces the separate teams that coordinated freight movement. Your overhead structure is your biggest vulnerability — compress it.',
          V: 'Equip every fleet manager, warehouse supervisor, and logistics coordinator with AI-powered optimization tools. Mandate adoption for all routing and scheduling decisions within 60 days. Track loads per driver, warehouse throughput, and on-time delivery rates before and after. The numbers will make the case.',
          B: 'Capture your veteran dispatchers\' and port operators\' operational knowledge in AI training programs now. Their intuition about weather routing, port congestion, and carrier reliability is perishable expertise — digitize it before the next wave of retirements eliminates it permanently.',
          R: 'Build an AI-native digital logistics platform that competes with the freight-tech startups entering your market. If a two-person digital brokerage with AI can match your freight volume, you need to be running that platform at 100x their scale. Your network is the asset — AI is how you weaponize it.',
          price_floor_drops: 'Your senior dispatchers and logistics planners hold routing and operational knowledge that no training manual captures. Build structured AI knowledge-transfer programs that encode their expertise into your optimization algorithms. Every retirement without knowledge capture is a permanent loss of competitive intelligence.',
          solo_operator: 'Redesign your logistics workflows around AI orchestration: automated load matching, AI-routed dispatching, real-time customs processing, and predictive exception handling in one integrated system. Retrain your coordinators as AI workflow managers. The multi-handoff model is already obsolete.',
          verification_bottleneck: 'Develop modular AI-powered logistics services — route optimization as a service, freight matching APIs, compliance automation — that you sell to smaller carriers while using internally. If your logistics capabilities are being unbundled by tech platforms, be the platform.',
    ...
    },
    {
      ...
      narratives: {
        ...
        recommendations: {
          H: 'Deploy AI-powered customer service, self-checkout, and inventory management across all locations within 12 months. Retrain your best service reps as customer experience specialists who handle high-value interactions AI can\'t. The rest of the service floor becomes a monitoring role.',
          M: 'Redesign your store and district operations around AI-augmented pods: one store manager + AI tools replacing a team of supervisors, schedulers, and coordinators. Start with scheduling and inventory replenishment, where the ROI is immediate. Your regional management layer needs reinvention or removal.',
          V: 'Mandate AI tool adoption across merchandising, e-commerce, and supply chain teams within 90 days. Measure sell-through, shrinkage, and fulfillment speed before and after. The performance gap will be so obvious it eliminates the debate.',
          B: 'Commission an AI rebuild of your demand forecasting, planogram optimization, and loyalty analytics systems. Run them alongside legacy systems for one season, then cut over. Every quarter you wait, your competitors\' models get smarter while yours stay static.',
          R: 'Launch an AI-native DTC channel that operates with zero legacy retail constraints \u2014 dynamic pricing, personalized experiences, predictive fulfillment. Let it compete with your own stores. Better you cannibalize yourself than watch a startup do it.',
          price_floor_drops: 'Your senior category buyers and merchandising leads need to become AI model trainers and exception handlers, not manual spreadsheet jockeys. Encode their expertise now, while they\'re still on payroll. Retirement takes the knowledge; AI keeps it.',
          solo_operator: 'Restructure promotional and seasonal planning workflows around AI orchestration where one category lead manages what five departments used to coordinate. Retrain coordinators as AI workflow managers. The alternative is five salaries for one outcome.',
          verification_bottleneck: 'Build modular retail experiences \u2014 AI-powered personal shopping, automated basics fulfillment, and premium in-store consultation \u2014 that compete at every price point. If you only sell the full-service bundle, DTC brands will cherry-pick your best margins.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'Your harvest crews, food safety inspectors, and grain elevator operators are being augmented by AI that optimizes combine routes via GPS-guided equipment, predicts crop yields from satellite imagery, and auto-generates FSMA compliance documentation. The agronomist who used to walk fields with a clipboard now reviews AI-generated soil analysis dashboards.',
          M: 'AI collapses what used to take a farm manager, an agronomist, a logistics coordinator, and a compliance officer into integrated precision agriculture platforms that one operator can run. Your per-acre overhead is about to crater.',
          V: 'Every farmer, rancher, and food production manager now has AI analyzing soil moisture, predicting pest outbreaks, optimizing irrigation schedules, and routing cold chain logistics before dawn. The operations that adopt produce 30% more per acre. The ones that don\'t are farming against algorithms.',
          B: 'Your crop rotation models, commodity pricing strategies, and pest management protocols are being rebuilt by AI that processes weather data, soil chemistry, satellite imagery, and market feeds simultaneously. The old extension service playbook isn\'t just outdated \u2014 it\'s leaving yield on the table.',
          R: 'AI-enabled agtech startups are offering precision agriculture services \u2014 variable-rate seeding, drone-based scouting, predictive harvest timing \u2014 that make your traditional farming operation look like it\'s working from a 1990s almanac. Your moat was land and experience. AI just made experience downloadable.'
        },
        scenarios: {
          price_floor_drops: 'Agronomic expertise, livestock management instincts, and decades of field experience \u2014 the knowledge that made the difference between a profitable harvest and a loss \u2014 is being encoded into precision agriculture platforms that any first-generation farmer can access. Your veteran farmers\' intuition is no longer a competitive advantage; it\'s a feature in a SaaS subscription.',
          solo_operator: 'A planting-to-harvest operation that required a farm manager, an agronomist, equipment operators, a logistics coordinator, and a commodity broker working in sequence can now be orchestrated by one operator with AI managing the workflow from soil prep to sale. The coordination overhead that justified your management layer just evaporated.',
          verification_bottleneck: 'AI lets a 500-acre operation access the same precision agriculture, compliance automation, and market analytics that used to require a 50,000-acre corporate farm\'s infrastructure. The scale advantage that justified consolidation weakens when technology equalizes the information gap.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy precision agriculture AI across your operations within 12 months: GPS-guided equipment optimization, AI-powered crop scouting, and automated FSMA compliance documentation. Retrain your best field managers as precision agriculture supervisors who manage AI-driven workflows instead of manual operations.',
          M: 'Redesign your farm management structure around AI-augmented operations: one manager with AI tools replacing the agronomist-coordinator-compliance triangle. Start with planting optimization and compliance documentation, where the ROI is immediate and measurable.',
          V: 'Mandate AI tool adoption across agronomy, equipment operation, and supply chain management within one growing season. Measure yield per acre, input costs, and compliance time before and after. The productivity gains will be visible in the first harvest.',
          B: 'Commission an AI rebuild of your crop planning, pest management, and commodity timing systems. Run them alongside traditional methods for one season, then transition. Every season you wait, competitors using precision agriculture pull further ahead on yield and cost.',
          R: 'Launch an AI-native precision agriculture services division that offers your technology stack to smaller regional operations. If agtech startups are democratizing your capabilities anyway, be the platform they buy from instead of the incumbent they disrupt.',
          price_floor_drops: 'Your veteran farmers and agronomists need to become AI model trainers, encoding their decades of field knowledge into precision agriculture systems before they retire. Every experienced operator who leaves without transferring knowledge to AI is institutional memory lost forever.',
          solo_operator: 'Restructure planting-to-harvest workflows around AI orchestration where one farm manager oversees what multiple coordinators used to handle. Retrain coordinators as AI workflow operators. The alternative is paying for coordination layers your competitors eliminated.',
          verification_bottleneck: 'Build modular precision agriculture services \u2014 AI-powered crop planning, automated compliance, predictive maintenance \u2014 that you can use internally and sell to smaller operations. If your scale advantage is eroding, monetize the technology that replaces it.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'Your geologists, drilling engineers, and mine planners are being augmented by AI that models ore bodies from drill core data, optimizes blast patterns for maximum recovery, and generates mine plans that human engineers take weeks to produce. The blasting specialist who relied on experience and rules of thumb watches AI design a fragmentation pattern that improves recovery by 15%.',
          M: 'AI collapses what used to take a geology team, a mine planning department, a safety compliance office, and an environmental monitoring group into integrated digital mine platforms that a fraction of the workforce can operate. Your cost per ton is about to drop \u2014 or your competitor\'s will.',
          ...
          B: 'Your resource estimation models, blast pattern designs, and tailings management systems are being rebuilt by AI that processes geological, environmental, and operational data simultaneously. The old mine planning methods aren\'t just conservative \u2014 they\'re leaving recoverable reserves in the ground.',
          R: 'AI-native mining tech companies are offering exploration analysis, mine optimization, and environmental compliance services that make your in-house capabilities look like they\'re running on spreadsheets. Your moat was geological IP and operational experience. AI just made both transferable.'
        },
        scenarios: {
          price_floor_drops: 'Geological interpretation expertise, blast engineering knowledge, and decades of operational judgment \u2014 the knowledge that took a mining engineer a career to develop \u2014 is being encoded into AI systems that compress years of learning into months. Your senior geologists\' ability to read a drill core and estimate reserves is no longer a scarce skill; it\'s an AI feature.',
          solo_operator: 'A mine expansion project that required geologists, drilling engineers, environmental consultants, safety officers, and regulatory specialists to coordinate across months can now be orchestrated by a lean team with AI managing the planning, compliance, and optimization workflow. The coordination overhead that justified your technical services headcount just became a cost disadvantage.',
          verification_bottleneck: 'AI lets a junior mining company with a small technical team access resource estimation, mine planning, and environmental impact assessment capabilities that previously required a major miner\'s in-house engineering department. The technical barriers to entry that protected your position are dissolving.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Deploy AI-powered mine planning, extraction optimization, and predictive maintenance across your operations within 18 months. Retrain your best mining engineers as AI-human teaming leads who validate AI-generated plans and manage exception workflows. The transition window is one mine plan cycle \u2014 miss it and your cost per ton becomes uncompetitive.',
          M: 'Redesign your technical services around AI-augmented teams: smaller geology and engineering pods with AI handling resource modeling, blast design, and compliance documentation. Start with mine planning and equipment maintenance, where the cost reduction is immediate. Your technical overhead needs to reflect AI productivity.',
          V: 'Mandate AI tool adoption across geology, mine engineering, and equipment operations within 12 months. Measure resource recovery, equipment utilization, and planning cycle time before and after. The productivity gains will reshape your operating model and your competitive position.',
          B: 'Commission an AI rebuild of your resource estimation, mine planning, and environmental monitoring systems. Run AI alongside legacy methods for one planning cycle, then transition. Every cycle you wait, your resource models and mine plans fall further behind what AI-optimized competitors are achieving.',
          R: 'Launch an AI-native exploration and technical services division that offers your analytical capabilities to junior miners and exploration companies. If mining tech startups are democratizing your engineering expertise, be the platform they buy from.',
          price_floor_drops: 'Your senior geologists and mining engineers need to become AI model trainers, encoding their geological interpretation skills and operational judgment into AI systems before they retire. The mining workforce is aging fast \u2014 every experienced engineer who leaves without transferring knowledge to AI is an irreversible loss of institutional capability.',
          solo_operator: 'Restructure mine development and expansion workflows around AI orchestration where lean teams manage what large technical departments used to coordinate. Retrain your technical coordinators as AI workflow managers.',
          verification_bottleneck: 'Build modular AI-powered mining services \u2014 resource estimation, blast optimization, environmental compliance \u2014 that you use internally and license externally. If your technical barriers are eroding, monetize the AI that replaces them.',
    ...
    },
    {
      ...
      narratives: {
        ...
        recommendations: {
          H: 'Deploy AI-powered NOC automation, customer service resolution, and field dispatch optimization across your operations within 12 months. Retrain your best NOC engineers as AI operations supervisors who manage exception handling and model tuning. The transition window is two years \u2014 after that, your cost-per-subscriber makes you uncompetitive.',
          M: 'Redesign your operations around AI-augmented pods: one senior network engineer + AI tools replacing the NOC team, dispatch office, and tier-1 support center. Start with alarm correlation and customer service, where the cost reduction is immediate. Your operations management layer needs to shrink or reinvent itself.',
          V: 'Mandate AI tool adoption across network engineering, cybersecurity, and sales engineering within 90 days. Measure mean time to resolution, threat detection speed, and proposal turnaround before and after. The productivity gains will be so clear they rewrite your operating model.',
          B: 'Commission an AI rebuild of your network planning, spectrum optimization, and churn prediction systems. Run AI models alongside legacy tools for one quarter, then cut over. Every quarter you wait, your network planning falls further behind the AI-optimized competitors.',
          R: 'Launch an AI-native managed services offering that competes with your own enterprise products at a lower price point. Let it cannibalize your legacy contracts before an MVNO or cloud provider does it for you.',
          price_floor_drops: 'Your senior RF engineers and network architects need to become AI model trainers and validators, not manual planners. Capture their expertise in AI systems now, while they\'re still on payroll. When they retire, that spectrum optimization knowledge either lives in your AI or it lives nowhere.',
          solo_operator: 'Restructure network upgrade and deployment workflows around AI orchestration where one project lead manages what five coordinators used to handle. Retrain coordinators as AI workflow managers. The alternative is paying for coordination overhead your competitors eliminated.',
          verification_bottleneck: 'Build modular service offerings \u2014 AI-managed connectivity, automated security monitoring, self-service provisioning \u2014 that compete at every price point. If you only sell the full-service enterprise bundle, lean competitors will cherry-pick your most profitable segments.',
    ...
    },
    {
      ...
      narratives: {
        dominant: {
          H: 'Your weapons systems engineers, intelligence analysts, and logistics officers are watching AI design flight control systems, correlate threat intelligence feeds, and optimize supply chains for readiness levels that human planners never achieved. The defense contractor who still staffs programs the old way is bidding against firms whose AI already passed the CDR.',
          M: 'AI is collapsing what used to require a systems engineering team, a test squadron, a cybersecurity division, and a program management office into integrated digital threads that a fraction of the headcount can operate. Your program overhead rates are about to become uncompetitive.',
          V: 'Every aerospace engineer, program manager, and cybersecurity operator now has AI running simulations, drafting ITAR-compliant documentation, and scanning classified networks for anomalies before the morning brief. The teams that adopt ship hardware on schedule. The teams that don\'t blow past Milestone C by years.',
          B: 'Your threat assessment models, mission planning algorithms, and satellite communications architectures are being rebuilt by AI that processes intelligence, models adversary behavior, and optimizes kill chains faster than any operations center. The old doctrine isn\'t just outdated — it\'s a vulnerability.',
          R: 'AI-enabled adversaries and AI-native defense startups are rewriting the competitive landscape. Your CMMC-certified, ITAR-compliant, 18-month procurement cycle looks like a handicap when a startup delivers an AI-powered ISR capability in six months for a tenth of the cost.'
        },
        scenarios: {
          price_floor_drops: 'Weapons systems expertise, flight test engineering knowledge, and classified threat analysis — the institutional knowledge that took decades to develop and required security clearances to access — is being encoded into AI systems that compress years of domain learning into weeks. Your greybeard engineers\' retirement isn\'t just a talent risk; it\'s a race to capture their knowledge in AI before it walks out the gate.',
          solo_operator: 'A program that required systems engineers, test pilots, cybersecurity teams, logistics planners, and a PMO to coordinate across three time zones can now be orchestrated by a lean team with AI managing the digital thread. The coordination overhead that justified your program office headcount just became your competitor\'s margin advantage.',
          verification_bottleneck: 'AI lets a 50-person defense tech startup deliver mission-ready capabilities that previously required a prime contractor with 5,000 engineers. The bundled defense services model — where the government paid for your infrastructure through cost-plus contracts — fractures when agile competitors deliver faster at firm-fixed-price.'
        },
        exposure: {
        ...
        recommendations: {
          H: 'Stand up an AI integration office that embeds AI tools into your engineering, cybersecurity, and logistics workflows within 12 months. Retrain your best systems engineers as AI-human teaming leads who validate AI-generated designs and analyses. The transition window aligns with your next major program bid — miss it and you\'re bidding with yesterday\'s cost structure.',
          M: 'Redesign your program execution model around AI-augmented teams: smaller engineering pods with AI handling simulation, documentation, and compliance checking. Start with proposal development and systems engineering, where the overhead reduction is immediate and quantifiable. Your indirect rates need to reflect AI productivity or your bids won\'t be competitive.',
          V: 'Mandate AI tool adoption across engineering, intelligence analysis, and cybersecurity teams within 180 days. Measure engineering output per labor hour before and after. The productivity gains will reshape your staffing models and make your next LPTA bid dramatically more competitive.',
          B: 'Commission an AI rebuild of your mission planning tools, threat assessment models, and systems engineering frameworks. Run them alongside legacy tools for one program phase, then transition. Every program phase you wait, your methods drift further from what the threat environment demands.',
          R: 'Launch an AI-native rapid prototyping division that operates outside your traditional program structure — small teams, commercial tools, sprint-based delivery. Let it compete for OTA and SBIR contracts that your main organization is too slow to pursue. Better you disrupt your own cost model than watch a defense tech startup do it.',
          price_floor_drops: 'Your senior systems engineers and weapons specialists need to become AI knowledge engineers, encoding their decades of classified expertise into AI systems before they retire. This isn\'t a nice-to-have — it\'s a national security imperative. Every grey-haired engineer who retires without transferring knowledge to AI is an irreversible loss.',
          solo_operator: 'Restructure program execution around AI-orchestrated digital threads where lean teams manage what large program offices used to coordinate. Retrain your program managers as AI workflow architects. The DoD is moving toward digital engineering mandates — be ahead of the requirement, not scrambling to comply.',
          verification_bottleneck: 'Build modular, AI-enabled capabilities that can be delivered independently or as integrated systems. If you only bid the monolithic program, agile competitors will win the pieces. Your platform advantage only holds if you can deliver at the speed and price point the new acquisition model demands.',
  ...
  var DOMINANT_IMPACT_SENTENCES = {
    H: 'AI is eliminating roles. The headcount pressure is the dominant force shaping your near-term reality.',
    M: 'AI is crushing your margins. Cost structures built for human-speed work can\'t compete with AI-speed economics.',
    V: 'AI is making everything faster. The velocity gains are so dramatic that your current pace becomes a competitive liability.',
    B: 'AI is eroding your moat. The expertise barriers that protected your market position are dissolving.',
    R: 'AI is forcing a reorg. Your organizational structure was designed for a world that no longer exists.'
  };
  ...
  //   dominant        - dominant impact code (e.g. "H")
  //   tasks         - the TASKS array (for score lookups)
  //   sectorWeights - the sector's weight map
  //   scenarios      - { pyramid_inverts, price_floor_drops, solo_operator, verification_bottleneck, speed_trap }
  //   physicalWeight - sum of weights for tasks 8-12, 29-32
var RECOMMENDATION_RULES = [
    // --- Dimension-dominant recommendations ---
    {
      id: 'headcount_dominant',
      condition: function (ctx) {
        return ctx.dominant === 'H';
      },
      recommendation: 'Redesign your workforce architecture now \u2014 redeploy before you downsize.'
    },
    {
      id: 'margin_dominant',
      condition: function (ctx) {
        return ctx.dominant === 'M';
      },
      recommendation: 'Rebuild your pricing model \u2014 AI economics are rewriting what your services are worth.'
    },
    {
      id: 'velocity_dominant',
      condition: function (ctx) {
        return ctx.dominant === 'V';
      },
      recommendation: 'Mandate AI adoption now \u2014 the speed gap between adopters and holdouts is already decisive.'
    },
    {
      id: 'barrier_dominant',
      condition: function (ctx) {
        return ctx.dominant === 'B';
      },
      recommendation: 'Shift your moat from expertise to judgment, proprietary data, and trust.'
    },
    {
      id: 'reorg_dominant',
      condition: function (ctx) {
        return ctx.dominant === 'R';
      },
      recommendation: 'Flatten your org chart \u2014 the layers that existed to route information are now redundant.'
    },
    ...
    // --- Scenario-driven recommendations ---
    {
      id: 'pyramid_inverts',
      condition: function (ctx) {
        return ctx.scenarios && ctx.scenarios.pyramid_inverts && ctx.scenarios.pyramid_inverts !== 'none';
      },
      recommendation: 'Your staffing pyramid is inverting \u2014 junior roles face AI displacement while senior roles don\'t. Redesign career ladders.'
    },
    {
      id: 'price_floor_drops',
      condition: function (ctx) {
        return ctx.scenarios && ctx.scenarios.price_floor_drops && ctx.scenarios.price_floor_drops !== 'none';
      },
      recommendation: 'New entrants will undercut your pricing. Build value above the commodity line before they arrive.'
    },
    {
      id: 'solo_operator',
      condition: function (ctx) {
        return ctx.scenarios && ctx.scenarios.solo_operator && ctx.scenarios.solo_operator !== 'none';
      },
      recommendation: 'One person can now do what a team did. Restructure around AI-augmented individuals, not departments.'
    },
    {
      id: 'verification_bottleneck',
      condition: function (ctx) {
        return ctx.scenarios && ctx.scenarios.verification_bottleneck && ctx.scenarios.verification_bottleneck !== 'none';
      },
    ...
    },
    {
      id: 'speed_trap',
      condition: function (ctx) {
        return ctx.scenarios && ctx.scenarios.speed_trap && ctx.scenarios.speed_trap !== 'none';
      },
      recommendation: 'Velocity gains are so extreme that not restructuring is itself a competitive death sentence.'
    },
  ...
  // ---------------------------------------------------------------------------
  // SCENARIO_DEFINITIONS — the five named scenarios with labels and descriptions
  // ---------------------------------------------------------------------------
  var SCENARIO_DEFINITIONS = {
    pyramid_inverts: {
      label: 'The Pyramid Inverts',
      description: 'Junior and routine roles face heavy AI displacement while senior roles remain insulated. The traditional staffing pyramid \u2014 many juniors supporting few seniors \u2014 breaks down.'
    },
    price_floor_drops: {
      label: 'The Price Floor Drops',
      description: 'AI enables comparable services at a fraction of the cost. New entrants and AI-native competitors undercut established pricing. The expertise premium that justified premium rates dissolves.'
    },
    solo_operator: {
      label: 'The Solo Operator',
      description: 'Coordination tasks collapse as one AI-augmented professional does what an entire team used to. Departments built on information routing and coordination become obsolete.'
    },
    verification_bottleneck: {
      label: 'The Verification Bottleneck',
      description: 'Execution automates but verification doesn\'t. Value shifts from "who can do the work" to "who can check the work." Audit, quality assurance, and human judgment become the scarcest and most valuable capabilities.'
    },
    speed_trap: {
      label: 'The Speed Trap',
      description: 'Velocity gains are so extreme that organizations that don\'t restructure become competitively irrelevant. The gap between AI-speed and human-speed operations creates an existential disadvantage.'
    }
  };
